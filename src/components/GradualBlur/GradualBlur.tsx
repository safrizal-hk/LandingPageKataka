...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      const mobileKey = `mobile${k}` as keyof Partial<GradualBlurProps>;
      const tabletKey = `tablet${k}` as keyof Partial<GradualBlurProps>;
      const desktopKey = `desktop${k}` as keyof Partial<GradualBlurProps>;
...
interface GradualBlurStatic extends React.FC<GradualBlurProps> {
  PRESETS: typeof PRESETS;
  CURVE_FUNCTIONS: typeof CURVE_FUNCTIONS;
}

const GradualBlurMemo = React.memo(GradualBlur) as unknown as GradualBlurStatic;

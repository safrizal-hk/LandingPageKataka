...
export function Services() {
  useEffect(() => {
    AOS.init({
      duration: 600,
      once: false, // tetap aktif ketika scroll ke atas dan bawah
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              <Card className="border-border bg-card hover:shadow-xl transition-transform duration-300 group hover:scale-105">
